...
function getData(ur){
    fetch(ur).then((response)=>{
        ...
        for(let i=0;i<p.length;i++)
       {
        ...
        tablebody.innerHTML="";
        tablebody.innerHTML="NOT FOUND, OR CHECK THE SPELLING - Format for Searching By Composition------    <br><i> Compound&ltspace&gt(potency)&ltspace&gt+&ltspace&gtCompound&ltspace&gt(potency)</i><br> i.e paracetamol (500mg) + aceclofenac (100mg)";
        }
...
function getData2(ur){
    fetch(ur).then((response)=>{
        ...
        for(let i=0;i<p.length;i++)
       {
        ...
        tablebody.innerHTML="";
        tablebody.innerHTML="NOT FOUND, OR CHECK THE SPELLING";}
